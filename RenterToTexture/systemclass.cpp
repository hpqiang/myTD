...
LRESULT SystemClass::InitWindow(int& screenWidth, int& screenHeight)
{
	...
	m_hwnd = CreateWindow(L"TutorialWindowClass", L"RenderToTexture", WS_OVERLAPPEDWINDOW,
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	m_applicationName = L"RenderToTexture";
	...
	//m_hwnd = CreateWindowEx(L"TutorialWindowClass", L"RenderToTexture", WS_OVERLAPPEDWINDOW,
