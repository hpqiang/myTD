...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), L"./data/seafloor.dds", "./data/cube.txt");
	if(!result)
	{
	...
	result = m_DebugWindow->Initialize(m_D3D->GetDevice(), screenWidth, screenHeight, 200, 200);
	if(!result)
	{
