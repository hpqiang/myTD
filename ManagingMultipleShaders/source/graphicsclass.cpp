...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model1->Initialize(m_D3D->GetDevice(), "./data/cube.txt", L"./data/marble.dds");
	if(!result)
	{
	...
	result = m_Model2->Initialize(m_D3D->GetDevice(), "./data/cube.txt", L"./data/metal.dds");
	if(!result)
	{
	...
	result = m_Model3->Initialize(m_D3D->GetDevice(), "./data/cube.txt", L"./data/stone.dds", 
								  L"./data/normal.dds");
	if(!result)
	{
