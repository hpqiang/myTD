...
ContentD3DOPGeometry::ContentD3DOPGeometry()
{
...
bool ContentD3DOPGeometry::initializeCamera()
{
...
bool ContentD3DOPGeometry::initializeModel()
{
	bool result;
...
bool ContentD3DOPGeometry::initializeTextureShader(HWND hwnd)
{
	bool result;
...
void ContentD3DOPGeometry::D3DRender(int rot)
{
